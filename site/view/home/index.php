        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="../upload/images/slider1.jpg" alt="slider 1">
                </div>

                <div class="item">
                    <img src="../upload/images/slider_2.jpg" alt="slider 2">
                </div>

                <div class="item">
                    <img src="../upload/images/slider_3.jpg" alt="slider 3">
                </div>
            </div>
...
<main id="maincontent" class="page-main">
    <div class="container">
        ...
        <div class="row equal">
            <div class="col-xs-12">
                <h4 class="home-title"><?php echo $categoryProduct['categoryName'] ?></h4>
            </div>

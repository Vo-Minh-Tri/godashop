        ...
        <div class="modal-content">
            <div class="modal-header bg-color">
                ...
                <div class="text-center">
                    <a class="btn btn-primary google-login" href="#"><i class="fab fa-google"></i></i> Đăng nhập bằng
                        Google</a>
                    <!-- Facebook login -->
                    <a class="btn btn-primary facebook-login" href="#"><i class="fab fa-facebook-f"></i> Đăng nhập bằng
                        Facebook</a>
                </div>
            </div>
            <form action="#" method="POST" role="form">
                    ...
                    <div class="cart-product">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-1">
                                    <div><img class="img-responsive"
                                            src="../upload/images/beaumoreSecretWhiteningCream10g.jpg"
                                            alt="Kem làm trắng da 5 trong 1 Beaumore Secret Whitening Cream "></div>
                                </div>
                                <div class="col-sm-6 col-md-3"><a class="product-name" href="#">Kem làm trắng da 5 trong
                                        1 Beaumore Secret Whitening Cream</a></div>
                        ...
                        <div class="clearfix text-left">
                            <div class="row">
                                <div class="col-sm-6 col-md-1">
                                    <div><img class="img-responsive"
                                            src="../upload/images/suaRuaMatNgheBeaumore100g.jpg"
                        ...
                        <div class="clearfix text-left">
                            <div class="row">
                                <div class="col-sm-6 col-md-1">
                                    <div><img class="img-responsive" src="../upload/images/suaTamSandrasShowerGel.jpg"
                                            alt="Sữa tắm Sandras Shower Gel "></div>
                                </div>
                                <div class="col-sm-6 col-md-3"><a class="product-name" href="#">Sữa tắm Sandras Shower
                                        Gel</a></div>

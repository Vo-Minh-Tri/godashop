...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="../upload/images/logo.jpg" />
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 logo">
                    <a href="#"><img src="../upload/images/goda450x170_1.jpg" class="img-responsive"></a>
                </div>
                <div class="col-lg-4 col-md-4 hidden-sm hidden-xs call-action">
                    <a href="#"><img src="../upload/images/godakeben450x170.jpg" class="img-responsive"></a>
                </div>
                <!-- HOTLINE AND SERCH -->
